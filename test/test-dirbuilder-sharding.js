    ...
    describe('big dir', () => {
      ...
      it('imports a big dir', (done) => {
        ...
        pull(
          ...
          pull.collect((err, nodes) => {
            expect(err).to.not.exist
            expect(nodes.length).to.be.eql(2689)
      ...
      it('exports a big dir', (done) => {
        ...
        pull(
          ...
          pull.collect((err, nodes) => {
            ...
            expect(paths.length).to.be.eql(maxDirs + 1)
        ...
        function eachPath (path, index) {
          ...
          expect(pathElements.length).to.be.eql(2)
          expect(pathElements[1]).to.be.eql(leftPad(index.toString(), 4, '0'))
